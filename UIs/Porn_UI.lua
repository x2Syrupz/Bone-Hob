	...
	function library:NewWindow(porn,hub)
		...
		Searchbar.Font = Enum.Font.GothamSemibold ----Enum.Font.SourceSans
		...
		function TabHandler:NewSection(nam)
			...
			TabName.Font = Enum.Font.GothamSemibold --Enum.Font.Arial
			TabName.Text = name
			...
			function Element:Bind(nam,ke,callbackontyp,callbac)
				...
				NewBind.Font = Enum.Font.GothamSemibold ---Enum.Font.Arial
				NewBind.Text = name
				...
				Bind.Name = "Bind"
				Bind.Font = Enum.Font.GothamSemibold --Enum.Font.ArialBold
				Bind.Parent = NewBind
			...
			function Element:Button(name,callback)
				...
				NewButton.Font = Enum.Font.GothamSemibold --Enum.Font.Arial
				NewButton.Text = name 
				NewButton.TextColor3 = Color3.fromRGB(200,200,200)
				NewButton.TextSize = 14.000
				NewButton.Visible = true
				NewButton.ZIndex = 1
				btnRound.CornerRadius = UDim.new(0, 2)
			...
			function Element:Slider(nam,mi,ma,callbac)
				...
				NewSlider.Font = Enum.Font.GothamSemibold --Enum.Font.Arial
				NewSlider.Text = name
				...
				Des.Font = Enum.Font.GothamSemibold ---Enum.Font.Arial
				Des.Text = min..'/'..max
			...
			function Element:Dropdown(nam,lis,cb)
				local dropfunc = {}
				...
				DropdownToggle.Font = Enum.Font.GothamSemibold --Enum.Font.Arial
				...
				local function add(v)
					...
					DropListBtn.Font = Enum.Font.GothamSemibold --Enum.Font.Gotham
			...
			function  Element:Line(text,hidetext)
				...
				H1Text.Font = Enum.Font.GothamSemibold --Enum.Font.SourceSansBold
			...
			function Element:Box(nam,callbac)
				...
				NewBox.Font = Enum.Font.GothamSemibold --Enum.Font.Arial
				NewBox.Text = name
			...
			function Element:Toggle(nam,callback)
				...
				NewToggle.Font = Enum.Font.GothamSemibold --Enum.Font.Arial
				NewToggle.Text = name
