...
function Library:Folder(namehub,namehub2,color)
    ...
    Mainpagt.BackgroundColor3 = Color3.fromRGB(21, 21, 21)
...
local MainHub = Instance.new("Frame")
    ...
    texth3.Position = UDim2.new(0.180, 0, 0.2, 0)
...
local namehu = Instance.new("TextLabel")
    ...
    namehu.Position = UDim2.new(0.175, 0, 0.06, 0)
...
--by ดิส แจกทุกอย่างทีมี https://discord.gg/NvGY2vEkV2
    ...
    Main_UiXConner.CornerRadius = UDim.new(0, 15)
    ...
    Logo.Image = "http://www.roblox.com/asset/?id=10233554882"
...
function tap:Tab(text)
    ...
    TextLabel_Tap.BackgroundColor3 = color
    ...
    TextLabel_Tap.Text = " "
    TextLabel_Tap.TextColor3 = color
    TextLabel_Tap.TextSize = 1
...
--by ดิส แจกทุกอย่างทีมี https://discord.gg/NvGY2vEkV2
    ...
    MainFramePage.Size = UDim2.new(0, 550, 0, 39)
    ...
    FramePage.BackgroundColor3 = Color3.fromRGB(19 , 19, 19)
    ...
    ScolPage.BackgroundColor3 = Color3.fromRGB(19, 19, 19)
...
function page:Page()
    ...
    ScolPage2.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
...
function ems:Side_Button(text,callback)
    ...
    TextLabel_emsTextButton.BackgroundColor3 = color
    ...
    TextLabel_emsTextButton.TextColor3 = Color3.fromRGB(255, 255, 255)
...
function ems:Button(text,callback)
    ...
    TextButton_Pageframe_Uiconner1.CornerRadius = UDim.new(0, 4)
...
--by ดิส แจกทุกอย่างทีมี https://discord.gg/NvGY2vEkV2
    ...
    MheeFrameStroke1.Color = color
    MheeFrameStroke1.Transparency = 1
--by ดิส แจกทุกอย่างทีมี https://discord.gg/NvGY2vEkV2
...
--by ดิส แจกทุกอย่างทีมี https://discord.gg/NvGY2vEkV2
    ...
    ToggleButton2.BackgroundColor3 = color
    ...
    TextLabelToggle.BackgroundColor3 = color
...
function ems:Slder(text,min,max,de,callback)
    ...
    TalabelSlider.BackgroundColor3 = color
    ...
    MainValue.BackgroundColor3 = color
...
function ems:Ti(text)
    ...
    lineframe2.BackgroundColor3 = color
